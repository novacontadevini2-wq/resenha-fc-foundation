...
export function NextRoundCard({
  ...
  return (
    <Link to="/app/rodadas/$id" params={{ id: round.id }}>
      <SectionCard
      ...
      >
        <div className="flex items-center gap-4">
          <div className="rounded-lg bg-navy px-3 py-2 text-center text-white">
          ...
          <div>
            ...
            <p className="text-meta">
              {round.start_time?.slice(0, 5) ?? "20:00"} às {round.end_time?.slice(0, 5) ?? "22:00"}
            </p>
            <p className="text-meta mt-1 flex items-center gap-1">
            ...
            {personalStatus ? (
              <p className="mt-1 text-xs font-bold uppercase text-navy">
